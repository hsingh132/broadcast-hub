#!/usr/bin/env bash
# mux_consumer_ytb.sh — OBS-first to YouTube B with automatic file fallback
...
#   YT_INGEST      : rtmp://b.rtmp.youtube.com/live2     (or rtmp://a.rtmp.youtube.com/live2)
#   YT_KEY         : YouTube stream key (from KEY1/KEY2)
#
# NOTE: Keep this script executed with bash (dashboard uses `bash -lc ...`).
# CHANNEL: This is the B-side consumer. Dashboard should set YT_INGEST to rtmp://b.rtmp.youtube.com/live2 for this script.
